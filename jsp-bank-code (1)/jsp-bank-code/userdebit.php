...
<style>
      body{
      	background-image: linear-gradient(to right top, #2643be, #53739e, #4d427e, #58be6f);
      }
	.tops{
			margin-top: 100px;
		}
...
<form action="debitbackend.php" method="post">
	<div class="columns">
...
<div class="mt-5">
<button class="button is-primary is-outlined px-6 mb-5" name="submit" type="submit">Debit  </button>
</div>
</div>
</div>
</form>
